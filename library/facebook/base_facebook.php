...
abstract class BaseFacebook {
		...
		if ($signed_request) {
			...
			if (array_key_exists ( 'code', $signed_request )) {
				...
				if ($code && $code == $this->getPersistentData ( 'code' )) {
					// short-circuit if the code we have is the same as the one
					// presented
	...
	protected function makeRequest($url, $params, $ch = null) {
		...
		// disable the 'Expect: 100-continue' behaviour. This causes CURL to
		// wait
	...
	public function destroySession() {
		...
		// Javascript sets a cookie that will be used in getSignedRequest that
		// we
