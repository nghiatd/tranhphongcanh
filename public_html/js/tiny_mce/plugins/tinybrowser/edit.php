...
while ( ($filename = readdir ( $dh )) !== false ) {
	if ($filename != "." && $filename != ".." && ! is_dir ( $tinybrowser ['docroot'] . $editpath . $filename )) {
		...
		if ($findnow)
			...
			// assign file details to array, for all files or those that match
		// search
...
if ($passfeid == '' && $tinybrowser ['integration'] == 'tinymce') {
	...
	href="<?php echo $tinybrowser['tinymcecss']; ?>" /><?php
} else {
	?><link rel="stylesheet" type="text/css" media="all"
...
<script language="javascript" type="text/javascript"
	src="js/tinybrowser.js.php"></script>
</head>
...
?><div class="tabularwrapper">
					<table class="browse">
						<tr>
							<th><a
								href="?type=<?php echo $typenow.$passfeid.$sortbyget['name']; ?>"
								<?php echo $thclass['name']; ?>><?php echo TB_FILENAME; ?></a></th>
							<th><a
								href="?type=<?php echo $typenow.$passfeid.$sortbyget['size']; ?>"
								<?php echo $thclass['size']; ?>><?php echo TB_SIZE; ?></a></th>
							<th><a
								href="?type=<?php echo $typenow.$passfeid.$sortbyget['type']; ?>"
