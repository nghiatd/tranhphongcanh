...
// **************************CHECK IMAGE TYPE AND CONVERT TO TEMP
// TYPE*****************************
...
// ********************************Truncate Text to Given Length If
// Required***************************
...
function clean_filename($filename) {
	$reserved = preg_quote ( '\/:*?"<>|', '/' ); // characters that are illegal
	                                             // on any of the 3 major OS's and
	                                             // other strang characters
